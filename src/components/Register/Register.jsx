...
setErrorList(validationResult.error.details)
 ...
 let {data}= await axios.post('http://192.168.1.162:3000/add_admin', user);
...
<input type="email" onChange={getUser} id='email' className=' my-3' name='email' />

<label htmlFor="password"><h4>Password: </h4> </label>
<input type="password" onChange={getUser} id='password' className=' my-3' name='password' />
<button  type='submit' className='btn btn-outline-success'>{isLoading? <i className='fas fa-spinner fa-spin'></i>:"Register"}    </button>
      </form>
